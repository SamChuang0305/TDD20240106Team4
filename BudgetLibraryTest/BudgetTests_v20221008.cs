...
{
    public class BudgetTests_v20221008
    {
        ...
        public void QueryOneMonth()
        {
            _budgetRepo.GetAll().Returns(new List<Budget>
            {
                new Budget
                {
                    YearMonth = "202210", Amount = 3100,
                }
                , new Budget
                {
                    YearMonth = "202211", Amount = 3100,
                }
                , new Budget
                {
        ...
        public void QueryCrossTwoMonth()
        {
            ...
            _budgetRepo.GetAll().Returns(new List<Budget>
            {
                new Budget
                {
                    YearMonth = "202210", Amount = 310,
                }
                , new Budget
                {
                    YearMonth = "202211", Amount = 3000,
                }
            });
